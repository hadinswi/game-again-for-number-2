...
func apply_gravity(delta):
	...
	if is_on_floor():
		can_jump = true
		# Player is on the floor, you can perform actions here
		# For example, allowing the player to jump or perform other actions
	else:can_jump = false
		# Player is not on the floor, they are in the air
		# You can handle different behavior here if needed
